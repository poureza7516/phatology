            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="national_id" class="col-md-4 col-form-label text-md-right">{{ __('کد ملی :') }}</label>

                            <div class="col-md-6">
                                <input id="national_id" type="text" class="form-control @error('email') is-invalid @enderror" name="national_id" value="{{ old('email') }}" required autocomplete="email">
                        ...
                        <div class="form-group row">
                            <label for="type" class="col-md-4 col-form-label text-md-right">{{ __('  نوع کاربری:') }}</label>

                            <div class="col-md-6">
                                <select id="type" type="text" class="form-control " name="type">
                                          @if(Auth::user()->type=='employee' |Auth::user()->type=='dev')
